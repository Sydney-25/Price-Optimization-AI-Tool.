...
def load_data(file):
    try:
        ...
        for col in numeric_columns:
            ...
            print(df[col].head())  # Print first few values for inspection
            # Convert to numeric, forcing errors to NaN
            df[col] = pd.to_numeric(df[col], errors='coerce')
        
        # Drop rows with NaN in the specified columns *after* conversion
        ...
        return None  # Return None to signal that loading failed
