...
def load_data(file):
    try:
        ...
        numeric_columns = ['Price', 'Item_Quantity', 'Sales_Amount_No_Discount', 
    ...
    if uploaded_file:
        with st.spinner('Processing data...'):
            ...
            if df is not None:
                # Validate columns
                required_columns = [
                    'Store_ID', 'Item_ID', 'Price', 'Item_Quantity',
                ...
                st.success(f"Model trained successfully! R² Score: {model_score:.2f}")
